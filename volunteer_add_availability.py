...
def initial_calendar():
    ...
    initial_calendar = tkcalendar.Calendar(availability_screen, font = 'Arial 14', date_pattern="d/m/y", selectmode='day', foreground = 'black', mindate= today, maxdate= max)
    initial_calendar.pack()

    initial_calendar_button = tkinter.Button(availability_screen, text = "Continue", width = 30, command = final_calendar)
...
def final_calendar():
    ...
    final_calendar = tkcalendar.Calendar(final_calendar_screen, font = 'Arial 14', date_pattern="d/m/y", selectmode='day', foreground = 'black', mindate= initial_calendar_date, maxdate= max)
