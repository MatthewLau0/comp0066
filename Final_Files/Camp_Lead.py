...
def accommodation_portal():
    ...
    def add_new_block():
        ...
        def summary():
            ...
            edit_button.pack()
            submit_button = Button(accommodation_summary, text="Submit", command=submit_command, width=30, height=2)
            submit_button.pack()
...
def ration_portal():
    ...
    def add_new_ration():
        ...
        def summary():
            ...
            edit_button.pack()
            submit_button = Button(ration_summary, text="Submit", command=submit_command, width=30, height=2)
            submit_button.pack()
...
def toilets_portal():
    ...
    def add_new_toilet():
        ...
        def summary():
            ...
            edit_button.pack()
            submit_button = Button(toilet_summary, text="Submit", command=submit_command, width=30, height=2)
            submit_button.pack()
...
def medical_portal():
    ...
    def add_new_medical():
        ...
        def summary():
            ...
            edit_button.pack()
            submit_button = Button(medical_summary, text="Submit", command=submit_command, width=30, height=2)
            submit_button.pack()
...
def settings():
    ...
    def campTable():
            ...
            def confirmAge():
                ...
                if len(new_volunteer_error_list) > 0:
                    ...
                    def createvolunteerSubmit():
                        ...
                        update_details_toplevel_button = Button(update_details_toplevel, text="Proceed", command=logout_login, width=30, height=2)
                        update_details_toplevel_button.pack()

                        cancel_details_toplevel_button = Button(update_details_toplevel, text="Cancel", command=update_details_toplevel.destroy, width=30, height=2)
        ...
        select_camp_table_button = Button(volunteer_entry_screen, text="Edit Details", command=volunteerEntry, width=30, height=2)
        select_camp_table_button.pack()
        back_button = Button(volunteer_entry_screen, text="Cancel", command=volunteer_entry_screen.destroy, width=30, height=2)
        back_button.pack()
